            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? Array(5).fill(0).map((_, i) => (
                ...
                <tr key={b._id} className="table-row">
                  ...
                  <td className="table-td text-sm font-semibold">₹{b.subtotal?.toLocaleString('en-IN')}</td>
                  <td className="table-td text-sm text-orange-600">₹{b.taxTotal?.toLocaleString('en-IN')}</td>
                  <td className="table-td text-sm font-bold text-primary-700">₹{b.grandTotal?.toLocaleString('en-IN')}</td>
